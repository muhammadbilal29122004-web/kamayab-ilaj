        ...
        <nav className="flex items-center justify-between w-full h-16 pt-2 pb-6 border-b border-white/[0.02]">
          <div className="flex items-center gap-8 xs:gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-6 xs:gap-6 flex-wrap text-sm uppercase tracking-widest text-gold font-medium">
              ...
              <span className="cursor-pointer text-white border-b border-gold pb-1 transition-colors">Taveez</span>
        ...
        <div className="flex flex-col items-center justify-center py-16 gap-8">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-12 pb-12 border-b border-white/[0.02]">
              <div className="p-8 border border-gold-dark/30 rounded-2xl bg-obsidian-card flex flex-col gap-4 group hover:border-gold-dark/80 transition-all cursor-pointer shadow-xl shadow-black/40">
                 <div className="w-10 h-10 border border-gold border-dashed bg-obsidian flex items-center justify-center rotate-45 mb-4 shadow-[0_0_15px_#c24141]">
                    <div className="w-4 h-4 bg-jewel-red rotate-45" />
                 </div>
                 <h2 className="text-3xl text-gold-light font-serif group-hover:text-gold transition-colors">Nazar-e-Bad Ka Taveez</h2>
                 <p className="text-gold-dark/70 text-base leading-relaxed">Buri nazar se hifazat jo dushman ki aankh ka waar khatam kar deta hai aur hifaazat ka zariya banta hai.</p>
              </div>
              ...
              <div className="p-8 border border-gold-dark/30 rounded-2xl bg-obsidian-card flex flex-col gap-4 group hover:border-gold-dark/80 transition-all cursor-pointer shadow-xl shadow-black/40">
                 ...
                 <h2 className="text-3xl text-gold-light font-serif group-hover:text-gold transition-colors">Taveez Barae Rizq</h2>
                 <p className="text-gold-dark/70 text-base leading-relaxed">Mali pareshanio aur mohtaji se nijat, jiska pehnna rozgar aur rizaq me zabardust azafa kartha he.</p>
              </div>
